...
/*============== WATERMARK ==============*/
global.wm = 'By NoarTakt-Bot' //Main Watermark
global.wm2 = 'Iman'
global.wm3 = 'NoarBot' | By Iman'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `NoarBot | ʙʏ ${global.nameown}`
global.author = 'Iman' 
global.packname = 'ImanYuto'
global.danied = '✘ 𝗘𝗥𝗢𝗥 𝟰𝟬𝟰'
global.ultahowner = 'Oktober 26 2023'
